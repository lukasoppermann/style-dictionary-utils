...
describe('transform: colorToCss', () => {
  it('transforms `color` tokens to hex value', () => {
    ...
    {$value: {
        ...
        colorToCss.transform(item as TransformedToken, {}, {}),
      ),
  ...
  it('transforms `color` tokens to rgba value', () => {
    ...
    {$value: {
        ...
        colorToCss.transform(item as TransformedToken, {colorOutputFormat: 'rgb'}, {}),
      ),
  ...
  it('transforms `color` tokens to hsl value', () => {
    ...
    {$value: {
        ...
        colorToCss.transform(item as TransformedToken, {colorOutputFormat: 'hsl'}, {}),
      ),
